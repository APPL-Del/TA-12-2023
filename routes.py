...
from app.model.Svm import Result
...
def svmpredict():
    if(request.method == "POST") :
        ...
        db_result = Svm(
            jumlah_anggota_rumah_tangga = data['jumlah_anggota_rumah_tangga'][0],
            jumlah_kamar=data_result['jumlah_kamar'][0],
            jumlah_sapi = data_result['jumlah_sapi'][0],
            jumlah_kerbau = data_result['jumlah_kerbau'][0],
            jumlah_kuda = data_result['jumlah_kuda'][0],
            jumlah_kambing = data_result['jumlah_kambing'][0],
            jumlah_babi = data['jumlah_babi'][0],
            status_kredit_usaha_rakyat = data_result['status_kredit_usaha_rakyat'][0],
            status_rastra = data_result['status_rastra'][0],
            status_jamsostek = data_result['status_jamsostek'][0],
            status_asuransi = data_result['status_asuransi'][0],
            status_bpjs_mandiri = data_result['status_bpjs_mandiri'][0],
            status_kis = data_result['status_kis'][0],
            status_kip = data_result['status_kip'][0],
            status_kks = data_result['status_kks'][0],
            status_usaha_art = data_result['status_usaha_art'][0],
            ada_kapal = data_result['ada_kapal'][0],
            ada_perahu = data_result['ada_perahu'][0],
            ada_mobil = data_result['ada_mobil'][0],
            ada_motor = data_result['ada_motor'][0],
            ada_sepeda = data_result['ada_sepeda'][0],
            ada_laptop = data_result['ada_laptop'][0],
            ada_emas = data_result['ada_emas'][0],
            ada_tv = data_result['ada_tv'][0],
            ada_telepon = data_result['ada_telepon'][0],
            ada_pemanas = data_result['ada_pemanas'][0],
            ada_ac = data_result['ada_ac'][0],
            ada_lemari_es = data_result['ada_lemari_es'][0],
            ada_tabung_gas = data_result['ada_tabung_gas'][0],
            kepemilikan_rumah=data_result['kepemilikan_rumah'][0],
            kepemilikan_lahan = data_result['kepemilikan_lahan'][0],
            jenis_lantai = data_result['jenis_lantai'][0],
            jenis_dinding = data_result['jenis_dinding'][0],
            jenis_atap = data_result['jenis_atap'][0],
            sumber_air_minum = data_result['sumber_air_minum'][0],
            cara_peroleh_air_minum = data_result['cara_peroleh_air_minum'][0],
            sumber_penerangan_utama = data_result['sumber_penerangan_utama'][0],
            fasilitas_buang_air_besar = data_result['fasilitas_buang_air_besar'][0],
            buang_tinja = data_result['buang_tinja'][0],
            status_pkh = str(predicted_result)
            )
        db.session.add(db_result)
        db.session.commit()

    return render_template('result.html', data = data_result, result = predicted_result, model = svm_model)


@app.route('/svmpsoredict', methods=['POST'])
def svmpsoredict():
    if(request.method == "POST") :
        data = {
            'jumlah_anggota_rumah_tangga' : [request.form["jumlah_anggota_rumah_tangga"]],
